-- =============================================================================
--  mem_subsys_can.vhd  -  Subsistema de memoria con motor DMA (bursts)
--  Licencia: MIT
--
--  Calca de mem_subsys_usart con la region del CAN (0xA000_0000) en vez de la del IIC:
--    region 0x0000_0000 (bits 31:30 = "00")   -> RAM local, 1 ciclo
--    region 0x4000_0000 (bits 31:28 = "0100") -> registros del DMA, 1 ciclo
--    region 0xA000_0000 (bits 31:28 = "1010") -> IP CAN (can_mmio,
--                                                instanciado en el top; aqui
--                                                solo decode + ruteo de rdata)
--
--  NOTA de region: 0xA000_0000 es espacio del bus dmem INTERNO del RV32,
...
entity mem_subsys_can is
  ...
  port (
    ...
    -- region CAN (0xA000_0000, bits 31:28 = "1010")
    can_sel   : out std_logic;
    can_addr  : out std_logic_vector(7 downto 0);
    can_rdata : in  word_t;
...
end entity mem_subsys_can;

architecture rtl of mem_subsys_can is
  signal is_local, is_dmareg, is_can : std_logic;
...
begin
  ...
  is_can    <= '1' when dmem_addr(31 downto 28) = "1010" else '0';

  can_sel  <= is_can;
  can_addr <= dmem_addr(7 downto 0);
