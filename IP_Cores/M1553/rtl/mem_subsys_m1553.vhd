-- =============================================================================
--  mem_subsys_m1553.vhd  -  Subsistema de memoria con motor DMA (bursts)
--  Licencia: MIT
--
--  Calca de mem_subsys_can con la region del 1553 (0xC000_0000) en vez
--  de la del CAN:
--    region 0x0000_0000 (bits 31:30 = "00")   -> RAM local, 1 ciclo
--    region 0x4000_0000 (bits 31:28 = "0100") -> registros del DMA, 1 ciclo
--    region 0xC000_0000 (bits 31:28 = "1100") -> IP MIL-STD-1553 (m1553_mmio,
...
entity mem_subsys_m1553 is
  ...
  port (
    ...
    -- region 1553 (0xC000_0000, bits 31:28 = "1100")
    m_sel     : out std_logic;
...
end entity mem_subsys_m1553;

architecture rtl of mem_subsys_m1553 is
  signal is_local, is_dmareg, is_m1553 : std_logic;
...
begin
  ...
  is_m1553  <= '1' when dmem_addr(31 downto 28) = "1100" else '0';

  m_sel  <= is_m1553;
  m_addr <= dmem_addr(7 downto 0);
