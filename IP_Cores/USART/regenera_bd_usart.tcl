...
################################################################
# This is a generated script based on design: bd_soc_usart
#
...
# source bd_soc_usart_script.tcl
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set usart_rxd [ create_bd_port -dir I usart_rxd ]
  set usart_txd [ create_bd_port -dir IO usart_txd ]
  set usart_cts_n [ create_bd_port -dir I usart_cts_n ]
  set usart_rts_n [ create_bd_port -dir O usart_rts_n ]

  # Create instance: u_soc, and set properties
  set block_name soc_top_usart_wrap
  set block_cell_name u_soc
  if { [catch {set u_soc [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
...
{PMC_MIO 26 .. 36}}} \
  ...
  connect_bd_intf_net -intf_net axi_smc_lpd_M00_AXI [get_bd_intf_pins axi_smc_lpd/M00_AXI] [get_bd_intf_pins u_soc/s_axi]
  ...
  connect_bd_intf_net -intf_net u_soc_m_axi [get_bd_intf_pins u_soc/m_axi] [get_bd_intf_pins axi_noc_0/S06_AXI]
  connect_bd_intf_net -intf_net u_soc_m_axi_usart [get_bd_intf_pins u_soc/m_axi_usart] [get_bd_intf_pins axi_noc_0/S07_AXI]
  ...
  connect_bd_intf_net -intf_net versal_cips_0_M_AXI_LPD [get_bd_intf_pins versal_cips_0/M_AXI_LPD] [get_bd_intf_pins axi_smc_lpd/S00_AXI]
  ...
  connect_bd_net -net Net  [get_bd_ports usart_txd] \
  [get_bd_pins u_soc/usart_txd]
  connect_bd_net -net rst_pl0_peripheral_aresetn  [get_bd_pins rst_pl0/peripheral_aresetn] \
  [get_bd_pins u_soc/aresetn] \
  [get_bd_pins axi_smc_lpd/aresetn]
  connect_bd_net -net u_soc_irq_out  [get_bd_pins u_soc/irq_out] \
  [get_bd_pins versal_cips_0/pl_ps_irq0]
  connect_bd_net -net u_soc_usart_irq_out  [get_bd_pins u_soc/usart_irq_out] \
  [get_bd_pins versal_cips_0/pl_ps_irq1]
  connect_bd_net -net u_soc_usart_rts_n  [get_bd_pins u_soc/usart_rts_n] \
  [get_bd_ports usart_rts_n]
  connect_bd_net -net usart_cts_n_0_1  [get_bd_ports usart_cts_n] \
  [get_bd_pins u_soc/usart_cts_n]
  connect_bd_net -net usart_rxd_0_1  [get_bd_ports usart_rxd] \
  [get_bd_pins u_soc/usart_rxd]
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces u_soc/m_axi] [get_bd_addr_segs axi_noc_0/S06_AXI/C0_DDR_LOW0] -force
  assign_bd_address -offset 0x000800000000 -range 0x000180000000 -target_address_space [get_bd_addr_spaces u_soc/m_axi] [get_bd_addr_segs axi_noc_0/S06_AXI/C0_DDR_LOW1] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces u_soc/m_axi_usart] [get_bd_addr_segs axi_noc_0/S07_AXI/C0_DDR_LOW0] -force
  assign_bd_address -offset 0x000800000000 -range 0x000180000000 -target_address_space [get_bd_addr_spaces u_soc/m_axi_usart] [get_bd_addr_segs axi_noc_0/S07_AXI/C0_DDR_LOW1] -force
  ...
  assign_bd_address -offset 0x80000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces versal_cips_0/M_AXI_LPD] [get_bd_addr_segs u_soc/s_axi/reg0] -force
