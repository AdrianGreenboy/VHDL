...
################################################################
# This is a generated script based on design: pcs_soc_bd
#
...
{PMC_MIO 26 .. 36}}} \
  ...
  # Create instance: soc_pcs_0, and set properties
  set block_name soc_top_pcs_wrap
  set block_cell_name soc_pcs_0
  if { [catch {set soc_pcs_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins smartconnect_0/M00_AXI] [get_bd_intf_pins soc_pcs_0/s_axi]
  connect_bd_intf_net -intf_net soc_pcs_0_m_axi [get_bd_intf_pins soc_pcs_0/m_axi] [get_bd_intf_pins axi_noc_0/S06_AXI]
  ...
  [get_bd_pins soc_pcs_0/aresetn] \
  [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net soc_pcs_0_irq_out  [get_bd_pins soc_pcs_0/irq_out] \
  ...
  assign_bd_address -offset 0xA4000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces versal_cips_0/M_AXI_FPD] [get_bd_addr_segs soc_pcs_0/s_axi/reg0] -force
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces soc_pcs_0/m_axi] [get_bd_addr_segs axi_noc_0/S06_AXI/C3_DDR_LOW0] -force
  assign_bd_address -offset 0x000800000000 -range 0x000180000000 -target_address_space [get_bd_addr_spaces soc_pcs_0/m_axi] [get_bd_addr_segs axi_noc_0/S06_AXI/C3_DDR_LOW1] -force
