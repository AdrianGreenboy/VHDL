-- =============================================================================
--  mem_subsys_pqc.vhd  -  Subsistema de memoria con motor DMA (bursts)
--  Licencia: MIT
--
...
--    region 0xD000_0000 (bits 31:28 = "1101") -> IP Ethernet MAC (pqc_mmio,
...
end entity mem_subsys_pqc;

architecture rtl of mem_subsys_pqc is
  signal is_local, is_dmareg, is_pqc : std_logic;
...
begin
  ...
  is_pqc  <= '1' when dmem_addr(31 downto 28) = "1101" else '0';
