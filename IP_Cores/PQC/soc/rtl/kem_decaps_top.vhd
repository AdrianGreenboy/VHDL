...
-- kem_decaps_top: wires the KeyGen sequencer to every verified block.
...
end entity kem_decaps_top;

architecture rtl of kem_decaps_top is
...
begin
  ...
  u_fsm : entity work.kem_decaps
    ...
    port map (clk => clk, rst_n => rst_n, start => start,
              ...
              c12_start => cd_start, c12_decode => cd_decode,
              c12_base => cd_base, c12_done => cd_done,
              cct_start => cct_start, cct_decode => cct_decode,
              cct_dsel => cct_dsel, cct_base => cct_base,
              cct_done => cct_done,
