...
################################################################
# This is a generated script based on design: bd_i3c
#
...
{PMC_MIO 26 .. 36}}} \
  ...
  # Create instance: soc_i3c_0, and set properties
  set block_name soc_top_i3c_wrap
  set block_cell_name soc_i3c_0
  if { [catch {set soc_i3c_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  connect_bd_intf_net -intf_net axi_smc_lpd_M00_AXI [get_bd_intf_pins axi_smc_lpd/M00_AXI] [get_bd_intf_pins soc_i3c_0/s_axi]
  ...
  connect_bd_intf_net -intf_net soc_i3c_0_m_axi [get_bd_intf_pins soc_i3c_0/m_axi] [get_bd_intf_pins axi_noc_0/S06_AXI]
  ...
  [get_bd_pins soc_i3c_0/scl]
  connect_bd_net -net Net1  [get_bd_ports sda] \
  [get_bd_pins soc_i3c_0/sda]
  connect_bd_net -net rst_pl0_peripheral_aresetn  [get_bd_pins rst_pl0/peripheral_aresetn] \
  [get_bd_pins soc_i3c_0/aresetn] \
  [get_bd_pins axi_smc_lpd/aresetn]
  connect_bd_net -net soc_i3c_0_i3c_irq_out  [get_bd_pins soc_i3c_0/i3c_irq_out] \
  [get_bd_pins versal_cips_0/pl_ps_irq1]
  connect_bd_net -net soc_i3c_0_irq_out  [get_bd_pins soc_i3c_0/irq_out] \
  ...
  assign_bd_address -offset 0x80000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces versal_cips_0/M_AXI_LPD] [get_bd_addr_segs soc_i3c_0/s_axi/reg0] -force
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces soc_i3c_0/m_axi] [get_bd_addr_segs axi_noc_0/S06_AXI/C0_DDR_LOW0] -force
  assign_bd_address -offset 0x000800000000 -range 0x000180000000 -target_address_space [get_bd_addr_spaces soc_i3c_0/m_axi] [get_bd_addr_segs axi_noc_0/S06_AXI/C0_DDR_LOW1] -force
