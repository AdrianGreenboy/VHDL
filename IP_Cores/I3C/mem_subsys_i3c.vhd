-- =============================================================================
--  mem_subsys_i3c.vhd  -  Subsistema de memoria con motor DMA (bursts)
--  Licencia: MIT
--
--  Calca de mem_subsys_usart con la region del I3C (0x9000_0000) en vez de la del IIC:
--    region 0x0000_0000 (bits 31:30 = "00")   -> RAM local, 1 ciclo
--    region 0x4000_0000 (bits 31:28 = "0100") -> registros del DMA, 1 ciclo
--    region 0x9000_0000 (bits 31:28 = "1001") -> IP I3C (i3c_mmio,
--                                                instanciado en el top; aqui
--                                                solo decode + ruteo de rdata)
--
--  NOTA de region: 0x9000_0000 es espacio del bus dmem INTERNO del RV32,
...
entity mem_subsys_i3c is
  ...
  port (
    ...
    -- region I3C (0x9000_0000, bits 31:28 = "1001")
    i3c_sel   : out std_logic;
    i3c_addr  : out std_logic_vector(7 downto 0);
    i3c_rdata : in  word_t;
...
end entity mem_subsys_i3c;

architecture rtl of mem_subsys_i3c is
  signal is_local, is_dmareg, is_i3c : std_logic;
...
begin
  ...
  is_i3c    <= '1' when dmem_addr(31 downto 28) = "1001" else '0';

  i3c_sel  <= is_i3c;
  i3c_addr <= dmem_addr(7 downto 0);
