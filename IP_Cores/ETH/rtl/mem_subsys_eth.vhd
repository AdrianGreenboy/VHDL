-- =============================================================================
--  mem_subsys_eth.vhd  -  Subsistema de memoria con motor DMA (bursts)
--  Licencia: MIT
--
...
--    region 0xD000_0000 (bits 31:28 = "1101") -> IP Ethernet MAC (eth_mmio,
...
entity mem_subsys_eth is
  ...
  port (
    ...
    -- region ETH (0xD000_0000, bits 31:28 = "1101")
    m_sel     : out std_logic;
...
end entity mem_subsys_eth;

architecture rtl of mem_subsys_eth is
  signal is_local, is_dmareg, is_eth : std_logic;
...
begin
  ...
  is_eth  <= '1' when dmem_addr(31 downto 28) = "1101" else '0';
