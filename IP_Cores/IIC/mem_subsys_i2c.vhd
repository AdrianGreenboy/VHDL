-- =============================================================================
--  mem_subsys_i2c.vhd  -  Subsistema de memoria con motor DMA (bursts)
--  Licencia: MIT
--
--  Calca de mem_subsys_usart con la region del IIC en vez de la del USART:
--    region 0x0000_0000 (bits 31:30 = "00")   -> RAM local, 1 ciclo
--    region 0x4000_0000 (bits 31:28 = "0100") -> registros del DMA, 1 ciclo
--    region 0x7000_0000 (bits 31:28 = "0111") -> IP IIC (i2c_mmio,
--                                                instanciado en el top; aqui
--                                                solo decode + ruteo de rdata)
--
--  NOTA de region: 0x7000_0000 es espacio del bus dmem INTERNO del RV32,
...
entity mem_subsys_i2c is
  ...
  port (
    ...
    -- region IIC (0x7000_0000, bits 31:28 = "0111")
...
end entity mem_subsys_i2c;

architecture rtl of mem_subsys_i2c is
  signal is_local, is_dmareg, is_i2c : std_logic;
...
begin
  ...
  is_i2c    <= '1' when dmem_addr(31 downto 28) = "0111" else '0';

  i2c_sel  <= is_i2c;
  i2c_addr <= dmem_addr(7 downto 0);
