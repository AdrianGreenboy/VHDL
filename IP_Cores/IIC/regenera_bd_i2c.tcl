...
################################################################
# This is a generated script based on design: bd_i2c
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: soc_i2c_0, and set properties
  set block_name soc_top_i2c_wrap
  set block_cell_name soc_i2c_0
  if { [catch {set soc_i2c_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
...
{PMC_MIO 26 .. 36}}} \
  ...
  set axi_smc_lpd [ create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect:1.0 axi_smc_lpd ]
  set_property -dict [list \
    CONFIG.NUM_MI {1} \
    CONFIG.NUM_SI {1} \
  ] $axi_smc_lpd
  ...
  connect_bd_intf_net -intf_net axi_noc_0_CH0_DDR4_1 [get_bd_intf_ports ddr4_bank0] [get_bd_intf_pins axi_noc_0/CH0_DDR4_0]
  connect_bd_intf_net -intf_net axi_smc_lpd_M00_AXI [get_bd_intf_pins axi_smc_lpd/M00_AXI] [get_bd_intf_pins soc_i2c_0/s_axi]
  ...
  connect_bd_intf_net -intf_net soc_i2c_0_m_axi [get_bd_intf_pins soc_i2c_0/m_axi] [get_bd_intf_pins axi_noc_0/S06_AXI]
  connect_bd_intf_net -intf_net versal_cips_0_FPD_CCI_NOC_4 [get_bd_intf_pins versal_cips_0/FPD_CCI_NOC_0] [get_bd_intf_pins axi_noc_0/S00_AXI]
  connect_bd_intf_net -intf_net versal_cips_0_FPD_CCI_NOC_5 [get_bd_intf_pins versal_cips_0/FPD_CCI_NOC_1] [get_bd_intf_pins axi_noc_0/S01_AXI]
  connect_bd_intf_net -intf_net versal_cips_0_FPD_CCI_NOC_6 [get_bd_intf_pins versal_cips_0/FPD_CCI_NOC_2] [get_bd_intf_pins axi_noc_0/S02_AXI]
  connect_bd_intf_net -intf_net versal_cips_0_FPD_CCI_NOC_7 [get_bd_intf_pins versal_cips_0/FPD_CCI_NOC_3] [get_bd_intf_pins axi_noc_0/S03_AXI]
  connect_bd_intf_net -intf_net versal_cips_0_LPD_AXI_NOC_1 [get_bd_intf_pins versal_cips_0/LPD_AXI_NOC_0] [get_bd_intf_pins axi_noc_0/S04_AXI]
  connect_bd_intf_net -intf_net versal_cips_0_M_AXI_LPD1 [get_bd_intf_pins versal_cips_0/M_AXI_LPD] [get_bd_intf_pins axi_smc_lpd/S00_AXI]
  connect_bd_intf_net -intf_net versal_cips_0_PMC_NOC_AXI_1 [get_bd_intf_pins versal_cips_0/PMC_NOC_AXI_0] [get_bd_intf_pins axi_noc_0/S05_AXI]

  # Create port connections
  connect_bd_net -net Net  [get_bd_ports scl] \
  [get_bd_pins soc_i2c_0/scl]
  connect_bd_net -net Net1  [get_bd_ports sda] \
  [get_bd_pins soc_i2c_0/sda]
  connect_bd_net -net rst_pl0_peripheral_aresetn  [get_bd_pins rst_pl0/peripheral_aresetn] \
  [get_bd_pins soc_i2c_0/aresetn] \
  [get_bd_pins axi_smc_lpd/aresetn]
  connect_bd_net -net soc_i2c_0_i2c_irq_out  [get_bd_pins soc_i2c_0/i2c_irq_out] \
  [get_bd_pins versal_cips_0/pl_ps_irq1]
  connect_bd_net -net soc_i2c_0_irq_out  [get_bd_pins soc_i2c_0/irq_out] \
  [get_bd_pins versal_cips_0/pl_ps_irq0]
  connect_bd_net -net versal_cips_0_fpd_cci_noc_axi0_clk1  [get_bd_pins versal_cips_0/fpd_cci_noc_axi0_clk] \
  [get_bd_pins axi_noc_0/aclk0]
  connect_bd_net -net versal_cips_0_fpd_cci_noc_axi1_clk1  [get_bd_pins versal_cips_0/fpd_cci_noc_axi1_clk] \
  [get_bd_pins axi_noc_0/aclk1]
  connect_bd_net -net versal_cips_0_fpd_cci_noc_axi2_clk1  [get_bd_pins versal_cips_0/fpd_cci_noc_axi2_clk] \
  [get_bd_pins axi_noc_0/aclk2]
  connect_bd_net -net versal_cips_0_fpd_cci_noc_axi3_clk1  [get_bd_pins versal_cips_0/fpd_cci_noc_axi3_clk] \
  [get_bd_pins axi_noc_0/aclk3]
  connect_bd_net -net versal_cips_0_lpd_axi_noc_clk1  [get_bd_pins versal_cips_0/lpd_axi_noc_clk] \
  [get_bd_pins axi_noc_0/aclk4]
  connect_bd_net -net versal_cips_0_pl0_ref_clk1  [get_bd_pins versal_cips_0/pl0_ref_clk] \
  [get_bd_pins rst_pl0/slowest_sync_clk] \
  [get_bd_pins soc_i2c_0/aclk] \
  [get_bd_pins axi_noc_0/aclk6] \
  [get_bd_pins axi_smc_lpd/aclk] \
  ...
  connect_bd_net -net versal_cips_0_pmc_axi_noc_axi0_clk1  [get_bd_pins versal_cips_0/pmc_axi_noc_axi0_clk] \
  [get_bd_pins axi_noc_0/aclk5]

  # Create address segments
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces soc_i2c_0/m_axi] [get_bd_addr_segs axi_noc_0/S06_AXI/C0_DDR_LOW0] -force
  assign_bd_address -offset 0x000800000000 -range 0x000180000000 -target_address_space [get_bd_addr_spaces soc_i2c_0/m_axi] [get_bd_addr_segs axi_noc_0/S06_AXI/C0_DDR_LOW1] -force
  ...
  assign_bd_address -offset 0x80000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces versal_cips_0/M_AXI_LPD] [get_bd_addr_segs soc_i2c_0/s_axi/reg0] -force
