-- rv32im_core_ce.vhd - Variante del core RV32IM con clock-enable sincrono.
...
end entity rv32im_core_ce;

architecture rtl of rv32im_core_ce is
  type t_state is (S_FETCH, S_EXEC, S_MEM, S_STORE, S_WB, S_HALT);
