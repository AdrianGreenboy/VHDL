...
//Date        : Sun Aug  9 05:45:58 2026
//Host        : adrian running 64-bit Ubuntu 24.04.4 LTS
//Command     : generate_target ecc_soc_bd.bd
//Design      : ecc_soc_bd
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "ecc_soc_bd,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=ecc_soc_bd,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "ecc_soc_bd.hwdef" *) 
module ecc_soc_bd
   (ddr4_bank0_act_n,
    ddr4_bank0_adr,
    ddr4_bank0_ba,
  ...
  wire soc_ecc_0_irq_out;
  wire [39:0]soc_ecc_0_m_axi_ARADDR;
  wire [1:0]soc_ecc_0_m_axi_ARBURST;
  wire [3:0]soc_ecc_0_m_axi_ARCACHE;
  wire [0:0]soc_ecc_0_m_axi_ARID;
  wire [7:0]soc_ecc_0_m_axi_ARLEN;
  wire [0:0]soc_ecc_0_m_axi_ARLOCK;
  wire [2:0]soc_ecc_0_m_axi_ARPROT;
  wire [3:0]soc_ecc_0_m_axi_ARQOS;
  wire [0:0]soc_ecc_0_m_axi_ARREADY;
  wire [2:0]soc_ecc_0_m_axi_ARSIZE;
  wire soc_ecc_0_m_axi_ARVALID;
  wire [39:0]soc_ecc_0_m_axi_AWADDR;
  wire [1:0]soc_ecc_0_m_axi_AWBURST;
  wire [3:0]soc_ecc_0_m_axi_AWCACHE;
  wire [0:0]soc_ecc_0_m_axi_AWID;
  wire [7:0]soc_ecc_0_m_axi_AWLEN;
  wire [0:0]soc_ecc_0_m_axi_AWLOCK;
  wire [2:0]soc_ecc_0_m_axi_AWPROT;
  wire [3:0]soc_ecc_0_m_axi_AWQOS;
  wire [0:0]soc_ecc_0_m_axi_AWREADY;
  wire [2:0]soc_ecc_0_m_axi_AWSIZE;
  wire soc_ecc_0_m_axi_AWVALID;
  wire [0:0]soc_ecc_0_m_axi_BID;
  wire soc_ecc_0_m_axi_BREADY;
  wire [1:0]soc_ecc_0_m_axi_BRESP;
  wire [0:0]soc_ecc_0_m_axi_BVALID;
  wire [31:0]soc_ecc_0_m_axi_RDATA;
  wire [0:0]soc_ecc_0_m_axi_RID;
  wire [0:0]soc_ecc_0_m_axi_RLAST;
  wire soc_ecc_0_m_axi_RREADY;
  wire [1:0]soc_ecc_0_m_axi_RRESP;
  wire [0:0]soc_ecc_0_m_axi_RVALID;
  wire [31:0]soc_ecc_0_m_axi_WDATA;
  wire soc_ecc_0_m_axi_WLAST;
  wire [0:0]soc_ecc_0_m_axi_WREADY;
  wire [3:0]soc_ecc_0_m_axi_WSTRB;
  wire soc_ecc_0_m_axi_WVALID;
  ...
  ecc_soc_bd_axi_noc_0_0 axi_noc_0
       (.CH0_DDR4_0_act_n(\^ddr4_bank0_act_n ),
        ...
        .S06_AXI_araddr({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,soc_ecc_0_m_axi_ARADDR}),
        .S06_AXI_arburst(soc_ecc_0_m_axi_ARBURST),
        .S06_AXI_arcache(soc_ecc_0_m_axi_ARCACHE),
        .S06_AXI_arid(soc_ecc_0_m_axi_ARID),
        .S06_AXI_arlen(soc_ecc_0_m_axi_ARLEN),
        .S06_AXI_arlock(soc_ecc_0_m_axi_ARLOCK),
        .S06_AXI_arprot(soc_ecc_0_m_axi_ARPROT),
        .S06_AXI_arqos(soc_ecc_0_m_axi_ARQOS),
        .S06_AXI_arready(soc_ecc_0_m_axi_ARREADY),
        .S06_AXI_arregion({1'b0,1'b0,1'b0,1'b0}),
        .S06_AXI_arsize(soc_ecc_0_m_axi_ARSIZE),
        .S06_AXI_arvalid(soc_ecc_0_m_axi_ARVALID),
        .S06_AXI_awaddr({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,soc_ecc_0_m_axi_AWADDR}),
        .S06_AXI_awburst(soc_ecc_0_m_axi_AWBURST),
        .S06_AXI_awcache(soc_ecc_0_m_axi_AWCACHE),
        .S06_AXI_awid(soc_ecc_0_m_axi_AWID),
        .S06_AXI_awlen(soc_ecc_0_m_axi_AWLEN),
        .S06_AXI_awlock(soc_ecc_0_m_axi_AWLOCK),
        .S06_AXI_awprot(soc_ecc_0_m_axi_AWPROT),
        .S06_AXI_awqos(soc_ecc_0_m_axi_AWQOS),
        .S06_AXI_awready(soc_ecc_0_m_axi_AWREADY),
        .S06_AXI_awregion({1'b0,1'b0,1'b0,1'b0}),
        .S06_AXI_awsize(soc_ecc_0_m_axi_AWSIZE),
        .S06_AXI_awvalid(soc_ecc_0_m_axi_AWVALID),
        .S06_AXI_bid(soc_ecc_0_m_axi_BID),
        .S06_AXI_bready(soc_ecc_0_m_axi_BREADY),
        .S06_AXI_bresp(soc_ecc_0_m_axi_BRESP),
        .S06_AXI_bvalid(soc_ecc_0_m_axi_BVALID),
        .S06_AXI_rdata(soc_ecc_0_m_axi_RDATA),
        .S06_AXI_rid(soc_ecc_0_m_axi_RID),
        .S06_AXI_rlast(soc_ecc_0_m_axi_RLAST),
        .S06_AXI_rready(soc_ecc_0_m_axi_RREADY),
        .S06_AXI_rresp(soc_ecc_0_m_axi_RRESP),
        .S06_AXI_rvalid(soc_ecc_0_m_axi_RVALID),
        .S06_AXI_wdata(soc_ecc_0_m_axi_WDATA),
        .S06_AXI_wlast(soc_ecc_0_m_axi_WLAST),
        .S06_AXI_wready(soc_ecc_0_m_axi_WREADY),
        .S06_AXI_wstrb(soc_ecc_0_m_axi_WSTRB),
        .S06_AXI_wvalid(soc_ecc_0_m_axi_WVALID),
  ...
  ecc_soc_bd_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
  ...
  ecc_soc_bd_smartconnect_0_0 smartconnect_0
  ...
  ecc_soc_bd_soc_ecc_0_0 soc_ecc_0
       (.aclk(versal_cips_0_pl0_ref_clk),
        .aresetn(proc_sys_reset_0_peripheral_aresetn),
        .irq_out(soc_ecc_0_irq_out),
        .m_axi_araddr(soc_ecc_0_m_axi_ARADDR),
        .m_axi_arburst(soc_ecc_0_m_axi_ARBURST),
        .m_axi_arcache(soc_ecc_0_m_axi_ARCACHE),
        .m_axi_arid(soc_ecc_0_m_axi_ARID),
        .m_axi_arlen(soc_ecc_0_m_axi_ARLEN),
        .m_axi_arlock(soc_ecc_0_m_axi_ARLOCK),
        .m_axi_arprot(soc_ecc_0_m_axi_ARPROT),
        .m_axi_arqos(soc_ecc_0_m_axi_ARQOS),
        .m_axi_arready(soc_ecc_0_m_axi_ARREADY),
        .m_axi_arsize(soc_ecc_0_m_axi_ARSIZE),
        .m_axi_arvalid(soc_ecc_0_m_axi_ARVALID),
        .m_axi_awaddr(soc_ecc_0_m_axi_AWADDR),
        .m_axi_awburst(soc_ecc_0_m_axi_AWBURST),
        .m_axi_awcache(soc_ecc_0_m_axi_AWCACHE),
        .m_axi_awid(soc_ecc_0_m_axi_AWID),
        .m_axi_awlen(soc_ecc_0_m_axi_AWLEN),
        .m_axi_awlock(soc_ecc_0_m_axi_AWLOCK),
        .m_axi_awprot(soc_ecc_0_m_axi_AWPROT),
        .m_axi_awqos(soc_ecc_0_m_axi_AWQOS),
        .m_axi_awready(soc_ecc_0_m_axi_AWREADY),
        .m_axi_awsize(soc_ecc_0_m_axi_AWSIZE),
        .m_axi_awvalid(soc_ecc_0_m_axi_AWVALID),
        .m_axi_bid(soc_ecc_0_m_axi_BID),
        .m_axi_bready(soc_ecc_0_m_axi_BREADY),
        .m_axi_bresp(soc_ecc_0_m_axi_BRESP),
        .m_axi_bvalid(soc_ecc_0_m_axi_BVALID),
        .m_axi_rdata(soc_ecc_0_m_axi_RDATA),
        .m_axi_rid(soc_ecc_0_m_axi_RID),
        .m_axi_rlast(soc_ecc_0_m_axi_RLAST),
        .m_axi_rready(soc_ecc_0_m_axi_RREADY),
        .m_axi_rresp(soc_ecc_0_m_axi_RRESP),
        .m_axi_rvalid(soc_ecc_0_m_axi_RVALID),
        .m_axi_wdata(soc_ecc_0_m_axi_WDATA),
        .m_axi_wlast(soc_ecc_0_m_axi_WLAST),
        .m_axi_wready(soc_ecc_0_m_axi_WREADY),
        .m_axi_wstrb(soc_ecc_0_m_axi_WSTRB),
        .m_axi_wvalid(soc_ecc_0_m_axi_WVALID),
  ...
  ecc_soc_bd_versal_cips_0_0 versal_cips_0
       (.FPD_CCI_NOC_0_araddr(versal_cips_0_FPD_CCI_NOC_0_ARADDR),
        ...
        .pl_ps_irq0(soc_ecc_0_irq_out),
        .pl_ps_irq1(1'b0),
        .pmc_axi_noc_axi0_clk(versal_cips_0_pmc_axi_noc_axi0_clk));
  ecc_soc_bd_xlconstant_1_0 xlconstant_1
