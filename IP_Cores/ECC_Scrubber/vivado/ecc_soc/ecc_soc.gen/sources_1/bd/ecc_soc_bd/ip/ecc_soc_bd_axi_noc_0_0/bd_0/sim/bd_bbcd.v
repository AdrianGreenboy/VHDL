...
//--------------------------------------------------------------------------------
//Command: generate_target bd_bbcd.bd
//Design : bd_bbcd
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_bbcd,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_bbcd,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=9,numReposBlks=9,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=None}" *) (* HW_HANDOFF = "ecc_soc_bd_axi_noc_0_0.hwdef" *) 
module bd_bbcd
   (CH0_DDR4_0_act_n,
    CH0_DDR4_0_adr,
    CH0_DDR4_0_ba,
  ...
  (* DONT_TOUCH *) 
  bd_bbcd_S00_AXI_nmu_0 S00_AXI_nmu
       (.AXI_IN(1'b0),
        ...
        .aclk(aclk0));
  (* DONT_TOUCH *) 
  bd_bbcd_S01_AXI_nmu_0 S01_AXI_nmu
       (.AXI_IN(1'b0),
        ...
        .aclk(aclk1));
  (* DONT_TOUCH *) 
  bd_bbcd_S02_AXI_nmu_0 S02_AXI_nmu
       (.AXI_IN(1'b0),
        ...
        .aclk(aclk2));
  (* DONT_TOUCH *) 
  bd_bbcd_S03_AXI_nmu_0 S03_AXI_nmu
       (.AXI_IN(1'b0),
        ...
        .aclk(aclk3));
  (* DONT_TOUCH *) 
  bd_bbcd_S04_AXI_rpu_0 S04_AXI_rpu
       (.AXI_IN(1'b0),
        ...
        .aclk(aclk4));
  (* DONT_TOUCH *) 
  bd_bbcd_S05_AXI_nmu_0 S05_AXI_nmu
       (.AXI_IN(1'b0),
        ...
        .aclk(aclk5));
  (* DONT_TOUCH *) 
  bd_bbcd_S06_AXI_nmu_0 S06_AXI_nmu
